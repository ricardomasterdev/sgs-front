@echo off
chcp 65001 >nul
title SGSx API - Gerenciador de Servico

:menu
cls
echo ========================================
echo   SGSx API - Gerenciador de Servico
echo ========================================
echo.
...
echo.
echo ============================================
echo   SGSx API - MODO DESENVOLVIMENTO
echo ============================================
echo.
echo Diretorio: C:\sgs-back
echo Porta: 8001
echo Certificados: mkcert (localhost)
echo Dominio: https://localhost:8001
echo.
...
echo.
echo ============================================
echo   SGSx API - MODO PRODUCAO
echo ============================================
echo.
echo Diretorio: C:\sgs-back
echo Porta: 8001
echo Certificados: Let's Encrypt
echo Dominio: https://api-sgs.cdxsistemas.com.br:8001
echo.
...
echo.
if exist "C:\sgs-back\logs\stdout.log" (
    powershell -Command "Get-Content 'C:\sgs-back\logs\stdout.log' -Tail 50 -Wait"
) else (
